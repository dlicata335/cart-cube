...
module com-glue-decomposed.Glue-WCoe where
  ...
  wcoe-isweq α T B f feq comT comB p r r' = 
    ...
    glue-weak' b' t = glue-weak {{snd (α (p r'))}} hcomB b' t
    ...
    -- Step 2: on r=r' and α r', the original g is in the fiber over b'(=unglue g) at r'(=r)
    g-in-fiber : (e : r == r') 
                 (g : G (p r))
    ...
    -- Step 3: on r=r' and α r', path comparing sending (b' g) up using the equivalence and g itself
    -- that we get from contractibility
    g-in-fiber-path : (g : _) (pα : fst (α (p r'))) (r=r' : _) 
